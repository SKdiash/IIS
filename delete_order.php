    ...
    if(isset($_POST["btn_submit_delete_order"]))
    {
        if(isset($_POST["del"])){
            ...
            if(!empty($del)){
                ...
                $_SESSION["error_messages"] .= "<p class='mesage_error'>Nebylo zadáno jméno objednávky, kterou chcete vymazat.</p>";
            ...
            // Pokud se nastala chyba - ukladame to do promenne
            $_SESSION["error_messages"] .= "<p class='mesage_error'>Nebylo zadáno jméno objednávky, kterou chcete vymazat. Zkuste to ještě jednou, prosím</p>";
        ...
        if(!$delet){
            // Pokud se nastala chyba - ukladame to do promenne
            $_SESSION["error_messages"] .= "<p class='mesage_error' >Nastala chyba při mazání objednávky.</p>";
            ...
            $_SESSION["success_messages"] = "<p class='success_message'>Mazání objednávky proběhlo úspěšně.</p>";
