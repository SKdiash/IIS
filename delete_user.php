...
<?php
    ...
    { 
        ...
        if(!$delete){
            ...
            $_SESSION["error_messages"] .= "<p class='mesage_error' >Nastala chyba při mazání účtu.</p>";
            ...
            $_SESSION["success_messages"] = "<p class='success_message'>Účet je úspěšně smazán.</p>";
